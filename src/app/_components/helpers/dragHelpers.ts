...
export const handleDragStart = (e: React.DragEvent, setDraggedShip: (ship: { size: number; orientation: "horizontal" | "vertical"; count: number; x: number; y: number }) => void) => {
...
export const handleDragOver = (e: React.DragEvent<HTMLTableElement>, boardData: BoardType, draggedShip: { size: number; orientation: "horizontal" | "vertical"; count: number; x: number; y: number } | null, setDraggedShip: (ship: { size: number; orientation: "horizontal" | "vertical"; count: number; x: number; y: number }) => void) => {
  e.preventDefault();
...
export const handleDragEnd = (setDraggedShip: (ship: { size: number; orientation: "horizontal" | "vertical"; count: number; x: number; y: number } | null) => void) => {
    setDraggedShip(null);
  };
